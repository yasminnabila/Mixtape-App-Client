...
<template>
  <div class="container-fluid">
    ...
    <div class="container-sm text-center mt-5" data-aos="zoom-in">
      <h1 class="display-4 justify-content-center">Welcome to Musicscape ✨</h1>
      <p class="h4 text-muted justify-content-center">
        Create your seamless mixtapes with us!
      </p>
    </div>
    <!-- HEADER -->
    ...
    <!-- HEADER -->
    <div class="container-sm text-center mt-5" data-aos="zoom-in">
      <p class="h2 text-muted justify-content-center">New Releases Album</p>
    </div>
    <!-- HEADER -->
